//Working solution is from the thinkful curriculum 
...
//Below is the first attempt code I did not get to work
...
//   const title = [
//     'Tommys Door Knob', 'Queen Sheeba', 'The Tickler', 'Broken Yokes'];
//   return title[Math.floor(Math.random() * title.length)];
// }

// function generateContent() {
//   const content = ['Mosnter goats from the planet fubar', 'The tale of two cities re-written from the view of hampsters', 'Apocalypse now, the true story of the Trump White House'];
//   return content[Math.floor(Math.random() * content.length)];
// }

// // function generateAuthor() {
// //   const author = [
// //     {firstName: 'Ted', lastName:"Franker"},
// //     {firstName: 'Motch', lastName:"Nonner"},
// //     {firstName: 'Amanda', lastName:"Almquist"},
// //     {firstName: 'Lisa', lastName:"Schults"}
// //   ];
...
//               'id', 'title', 'content', 'author', 'grade', 'address');
//           });
...
//           resBlog.address.should.contain(blog.address.building);

//           resBlog.grade.should.equal(blog.grade);
//         });
//     });
//   });
